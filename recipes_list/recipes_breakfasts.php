            ...
            <div class="recipes">
                <div class="container">
                    <div class="recipes__row">
                        <div class="recipes__title">- Завтраки -</div>
                        <div class="recipes">
                            <div class="recipe">
                                <img src="../pictures/омлет_цукини.jpg" alt="омлет_с_цукини" class="recipe">
                                <p class="recipes__theTitle">Омлет с цукини и помидорами</p>
                                <p>Завтраки</p>
                                <p class="recipes__description">Омлет с цукини и помидорами хорош как на завтрак, так и
